...
type SaleGoals struct {
	SaleGoalId   uint      `gorm:"primaryKey;autoIncrement;column:sale_goal_id"` // Primary key
	...
	IncomeItem IncomeItems `gorm:"foreignKey:IncomeItemId;references:IncomeItemId" json:"-"`
}
